...
export default function DataCleaningPage() {
  ...
  const exportProvenance = useCallback(() => {
    ...
    report += `\n${'─'.repeat(48)}\nGenerated by FieldScore Data Clean Room\n`;
            ...
            {tab === 'provenance' && (
              <div style={{ padding: 20 }}>
                ...
                <div style={{ background: '#0A0F1E', borderRadius: 10, padding: '16px 18px', fontFamily: 'monospace', fontSize: 11, lineHeight: 1.7, color: '#94A3B8', overflowX: 'auto' }}>
                  ...
                  <div style={{ color: '#4B5563' }}>FieldScore · Generated {new Date().toLocaleString('en-GB')}</div>
                  ...
                  {s && <>
                    ...
                    <div style={{ color: '#4B5563' }}>Generated by FieldScore Data Clean Room</div>
                  </>}
                </div>
              </div>
            )}
